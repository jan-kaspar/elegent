...
TComplex BSWModel::Omega0b(double b) const
{
	...
	double par[] = { b };
	return 0.5 * ComplexIntegrate(Omega0t_J0, par, this, upper_bound_t, 0., 0., precision_t,
...
TComplex BSWModel::Amp(double t) const
{
	...
	TComplex I = ComplexIntegrate(prf0_J0, par, this, 0., upper_bound_b, 0., precision_b,
