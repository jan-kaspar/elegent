...
{
  return ((BSWModel *)obj)->sample_eval(b[0]) * b[0] * TMath::BesselJ0(b[0] * q[0]);
}
...
void BSWModel::build_sample(unsigned int samples)
{
  printf(">> BSWModel::build_sample > Building %u samples...\n", samples);
...
TComplex BSWModel::sample_eval(double b)
{
